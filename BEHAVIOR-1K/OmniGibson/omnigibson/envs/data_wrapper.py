...
class DataPlaybackWrapper(DataWrapper):
    ...
    def create_from_hdf5(
        ...
        preserve_recorded_frequencies: bool = False,
        ...
        **kwargs,
        ...
        if include_contacts:
            if preserve_recorded_frequencies:
                # Keep the frequencies the demo was recorded at: each playback step then
                # integrates a full control period of dynamics from the restored state.
                # Physically-scaled joint efforts, at the cost of more physics leakage
                # between the restored state and the recorded next state.
                pass
            else:
